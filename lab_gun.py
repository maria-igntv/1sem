...
def new_game(event=''):
    ...
    t1.live = 1  # Кол - во необходимых попаданий в первую мишень.
    while True:
        ...
        if len(balls) == 0 and t1.live == 0:
            canv.itemconfig(screen1, text='')  # Сотрем надпись.
            t1.new_target()   # Нарисуем новую мишень.
